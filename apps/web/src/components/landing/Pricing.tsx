        ...
        <div className="text-center mb-12 flex flex-col items-center">
          ...
          <div className="bg-white rounded-full p-1.5 flex shadow-sm border border-brand-dark/5 mb-12">
            <button 
              ...
              className={`px-8 py-2.5 rounded-full text-xs font-sans tracking-wider font-medium transition-colors ${
                gender === "mujeres" ? "bg-brand-dark text-white" : "text-brand-muted hover:text-brand-dark"
              }`}
            >
              MUJERES
            </button>
            <button 
              ...
              className={`px-8 py-2.5 rounded-full text-xs font-sans tracking-wider font-medium transition-colors ${
                gender === "varones" ? "bg-brand-dark text-white" : "text-brand-muted hover:text-brand-dark"
              }`}
            >
              VARONES
            </button>
