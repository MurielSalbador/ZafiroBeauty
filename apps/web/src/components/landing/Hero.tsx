...
function ShimmerRing() {
  return (
    <motion.div
      ...
      style={{
        background:
          "conic-gradient(from 0deg, transparent 0%, #e8bdcc44 20%, transparent 40%, #fadcd966 60%, transparent 80%, #e8bdcc44 100%)",
      }}
      animate={{ rotate: 360 }}
...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#fdf6f5] via-[#faeae8] to-[#f5dbd9] min-h-[calc(100vh-6rem)] flex flex-col justify-between pt-16">

      {/* ── Falling petals ── */}
      {petals.map((p, i) => (
        <Petal key={i} startX={p.startX} delay={p.delay} />
      ))}
      ...
      <motion.svg
        className="absolute top-0 left-0 w-40 h-48 text-brand-muted/20 select-none pointer-events-none"
        viewBox="0 0 160 200"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      <motion.svg
        className="absolute bottom-16 left-0 w-36 h-44 text-brand-muted/20 select-none pointer-events-none"
        viewBox="0 0 160 180"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      <motion.svg
        className="absolute top-0 right-0 w-44 h-52 text-brand-muted/20 select-none pointer-events-none"
        viewBox="0 0 180 210"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      {/* Florecita pulsante */}
      <motion.svg
        className="absolute top-1/2 left-[48%] -translate-y-1/2 w-10 h-10 text-brand-muted/25 select-none pointer-events-none"
        viewBox="0 0 32 32"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      >
        ...
        <ellipse cx="16" cy="7" rx="3" ry="5" fill="currentColor" fillOpacity="0.1" />
        <ellipse cx="16" cy="25" rx="3" ry="5" fill="currentColor" fillOpacity="0.1" />
        <ellipse cx="7" cy="16" rx="5" ry="3" fill="currentColor" fillOpacity="0.1" />
        <ellipse cx="25" cy="16" rx="5" ry="3" fill="currentColor" fillOpacity="0.1" />
      </motion.svg>
      ...
      {[
        ...
        <motion.span
          key={i}
          className="absolute text-brand-muted/20 text-lg font-light select-none"
          style={pos as any}
      ...
      <div className="container mx-auto px-4 relative z-10 flex-1 flex items-center mb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            <motion.h1
              className="font-serif text-5xl md:text-6xl text-brand-text mb-6 leading-[1.1]"
              variants={itemVariants}
            >
              Tu mejor versión <br />
              <motion.span
                className="italic text-brand-muted inline-block"
            ...
            <motion.p
              className="font-serif italic text-lg md:text-xl text-brand-muted mb-8"
              variants={itemVariants}
            >
            ...
            <motion.p
              className="text-[13px] text-brand-text/80 mb-6 max-w-md font-sans leading-relaxed"
              variants={itemVariants}
            >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-0.5">
                        <span className="text-xs text-brand-muted flex items-center gap-1">
                          <Clock size={12} /> {nextAppointment.time} hs
                        </span>
                        <span className="text-xs text-brand-muted flex items-center gap-1">
                          <span className="w-2 h-2 rounded-full bg-yellow-500" /> Pendiente
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <motion.div className="flex flex-col sm:flex-row items-center gap-4" variants={itemVariants}>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.04, backgroundColor: "rgba(92,64,51,0.05)" }}
                whileTap={{ scale: 0.97 }}
              >
                VER PRECIOS
              </motion.a>
          ...
          {/* Columna Derecha — logo 3D con parallax */}
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              style={{ background: "radial-gradient(circle, #fadcd960 0%, #e8bdcc20 50%, transparent 70%)" }}
            ...
            <motion.div
              className="absolute w-[460px] h-[460px] rounded-full border border-[#e8bdcc]/30"
              animate={{ rotate: 360 }}
            ...
            {/* Logo con 3D tilt */}
            <motion.div
              className="w-[420px] h-[420px] rounded-full bg-white/50 shadow-xl shadow-brand-dark/5 backdrop-blur-sm p-6 relative flex items-center justify-center border border-white/70"
              style={{ rotateX: logoRotateX, rotateY: logoRotateY, transformPerspective: 800 }}
            >
              <ShimmerRing />
            ...
            {/* Orbes flotantes alrededor del logo */}
            {[
              { x: -180, y: -60, size: 12, color: "#fadcd9", delay: 0 },
              { x: 190, y: 80, size: 8, color: "#e8bdcc", delay: 1 },
              { x: -140, y: 150, size: 10, color: "#d4a0b0", delay: 2 },
              { x: 160, y: -120, size: 6, color: "#fadcd9", delay: 0.5 },
              { x: 0, y: -210, size: 14, color: "#e8bdcc", delay: 1.5 },
            ].map((orb, i) => (
              <motion.div
                key={i}
      ...
      {/* Barra inferior */}
      <motion.div
        className="bg-brand-dark text-white py-8 w-full mt-auto"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
            {[
              ...
              { value: "100%", label: "Tecnología Láser" },
              { value: "12-99", label: "Edad Apta" },
            ].map((stat, i) => (
              <motion.div
                key={i}
              ...
              >
                <span className="font-serif text-2xl md:text-3xl mb-1">{stat.value}</span>
                <span className="text-[9px] uppercase tracking-[0.2em] text-white/80">{stat.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
